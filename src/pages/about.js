...
export default () => (
  <div>
	...
	<i class="about-sub">Joshua Blewitt is a Test Engineer, hobbyist developer and aspiring Web Developer.</i>
	<div class="about-box">
		<div class="column-about">
			<p><img id="image-about-right" src={Image} alt="I sure love donuts 🍩"></img>I'm an IT Professional with about 7 years of experience. I'm currently a Software Test Engineer at IQVIA. I've previously worked for companies like Domino's Pizza Group. I've mostly worked within testing of software.
			<br></br>
			<br></br>
